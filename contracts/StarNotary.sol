...
contract StarNotary is ERC721 {
    ...
    string public name = "Heraclitus-StarNotary";
    string public symbol = "'USD' -> 'American Dollar'";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "Not authorized");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Invalid sender for request");
